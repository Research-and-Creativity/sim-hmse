...
class ProkerController extends Controller
{
    ...
    public function show(string $id)
    {
        ...
        $proker = [
            ...
            'date_start' => $prokerRow->date_start ? \Illuminate\Support\Carbon::parse($prokerRow->date_start)->format('d M Y') : '-',
            'date_end' => $prokerRow->date_end ? \Illuminate\Support\Carbon::parse($prokerRow->date_end)->format('d M Y') : '-',
